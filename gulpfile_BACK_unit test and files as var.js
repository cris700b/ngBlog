...
gulp.task('lint', ['clean-js-app-file'], function(){
	...
	return gulp.src([mainJsFile, moduleInitFile, jsFiles,  '!' + testFiles, '!' + bowerFiles])
					.pipe(jshint())
...
gulp.task('copy-files', ['clean-dist', 'minify-css', 'minify-js'], function(){
	...
	return gulp.src([minJsFile, minCssFile, htmlFiles, '!' + testFiles, '!' + bowerFiles])
